...
Route::post('/', function() {
	...
	// If the ur is alreday in the table, return it
	...
	// otherwise, add a new row, and return the shortned url
	...
	// Create a resukt view, and present the short url to the user

});

Route::get('(:any)', function($surl) {
	$row = Url::where_shortened($surl)->first();
